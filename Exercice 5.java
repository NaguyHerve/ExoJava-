/* Saisir une serie de N nombres positifs puis determinez la valeur
        1- La valeur min et la valeur max 
        2- les 2 valeurs min et les deux valeurs max
        3- La somme des valeurs premières
...
public class Exo5 {
    public static void main(String[] args) {
        ...
        System.out.println("Combien de valeurs voulez vous ajouter: ");
        int n= sc.nextInt();
        ...
        while (n>0){
            j= i+1;
            System.out.println("Saisir une valeurs positive "+j+": ");
            int x= sc.nextInt();
            while (x<0){
                System.out.println("Saisir une valeur correcte "+j+": ");
                x = sc.nextInt();
            }
            Liste.add(x);
            i++;
